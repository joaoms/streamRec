...
for nn in num_nodes:
    print("## ", nn, " ##")
    model = UBISGD(ImplicitData([],[]), num_factors, num_iter, nn, learn_rate = learn_rate, u_regularization = regularization, i_regularization = regularization, random_seed = 10)
